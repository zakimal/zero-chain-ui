	...
	readyRender() {
		return (<div>
			...
			<Segment style={{ margin: '1em' }} padded>
				...
				<div style={{ fontSize: 'small', paddingTop: '1em' }}>Encrypted fee by sender (64 bytes)</div>
				<InputBond bond={this.enc_fee} validator={n => n || null} placeholder='0x...' />
				<Divider hidden />
				<TransactButton
...
function get_calls(sender, recipient, amount, balance, provingKey, preparedVk, fee) {
	return Bond.mapAll([sender, recipient, amount, balance, provingKey, preparedVk, fee],
		(sender, recipient, amount, balance, provingKey, preparedVk, fee) => {
			...
			let args = gen_call(sk, recipient, amount, balance, provingKey, preparedVk, randomSeed, fee) // TODO:
			return {
				sender: sender,
				call: calls.confTransfer.confidentialTransfer(
					args.zk_proof,
